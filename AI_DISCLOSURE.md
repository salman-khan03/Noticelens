...
This implementation was created with OpenAI Codex coding assistance, including architecture, TypeScript/React UI, Python API, source retrieval scripts, tests and documentation. OpenAI Image Generation produced the design reference in `docs/design-concept.png`. The shipped interface is code, not a static generated screenshot. No Claude coding assistance was used in this session.
