...
- [x] Inspect empty workspace and user brief.
- [x] Define a narrow Texas tenant vertical slice and trust boundaries.
- [x] Design the application surface and build upload → overview → evidence → gate → actions.
- [x] Add synthetic fixtures, real PDF extraction, OCR adapter and text fallback.
...
- [ ] Public deployment after worker isolation and edge limits.
