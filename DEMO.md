...
1. Open the app and load the synthetic Notice to vacate. Explain that this is a fictional notice and that processing uses the local rules provider.
2. Show the September 18 date as a **document-stated assertion**, not a validated legal deadline. Open its passage.
3. Expand the notice-period claim. Show the official URL, preserved exact passage and retrieval date. Explain the lease exception and why applicability still needs human review.
4. Show the deliberately injected claim: “You always have 14 days to respond to this notice.” It is blocked. Coverage reads 66.7%, not a manufactured 100%.
